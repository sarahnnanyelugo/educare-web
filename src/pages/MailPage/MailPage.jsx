        ...
        <div className="col-md-4">
          <div className="col-md-11">
            <ThreeItemComponent
              ...
              paragraph="Our email service is built on a secure infrastructure designed to protect your data from external threats. We utilize industry-standard security protocols and regularly update our systems to ensure the highest level of security for your email communications."
              icon={Tick}
            />
          </div>
        </div>{" "}
        <div className="col-md-4 offset-md-1">
          <div className="col-md-11">
            <ThreeItemComponent
              ...
              paragraph="We believe in empowering our users to control their own data. Our email service provides you with granular control over your privacy settings, allowing you to customize and manage the information you share. We obtain your consent for data processing activities, ensuring that you have full control over how your data is used."
              icon={Person}
            />
          </div>
        </div>
